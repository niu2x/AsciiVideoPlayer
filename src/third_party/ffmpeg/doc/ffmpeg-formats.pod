...
=item B<-window_size> I<size>B<>

Set the maximum number of segments kept in the manifest.

=item B<-extra_window_size> I<size>B<>

Set the maximum number of segments kept outside of the manifest before removing from disk.

=item B<-remove_at_exit> I<remove>B<>

Enable (1) or disable (0) removal of all segments when finished.

=item B<-use_template> I<template>B<>

Enable (1) or disable (0) use of SegmentTemplate instead of SegmentList.

=item B<-use_timeline> I<timeline>B<>

Enable (1) or disable (0) use of SegmentTimeline in SegmentTemplate.

=item B<-single_file> I<single_file>B<>

Enable (1) or disable (0) storing all segments in one file, accessed using byte ranges.

=item B<-single_file_name> I<file_name>B<>
...
=item B<-init_seg_name> I<init_name>B<>
...
=item B<-media_seg_name> I<segment_name>B<>
...
=item B<-utc_timing_url> I<utc_url>B<>

URL of the page that will return the UTC timestamp in ISO format. Example: "https://time.akamai.com/?iso"

=item B<method> I<method>B<>

Use the given HTTP method to create output files. Generally set to PUT or POST.

=item B<-http_user_agent> I<user_agent>B<>

Override User-Agent field in HTTP header. Applicable only for HTTP output.

=item B<-http_persistent> I<http_persistent>B<>

Use persistent HTTP connections. Applicable only for HTTP output.

=item B<-hls_playlist> I<hls_playlist>B<>
...
=item B<-timeout> I<timeout>B<>

Set timeout for socket I/O operations. Applicable only for HTTP output.

=item B<-index_correction> I<index_correction>B<>
...
=item B<-format_options> I<options_list>B<>
...
=item B<-dash_segment_type> I<dash_segment_type>B<>
...
=item B<hls_init_time> I<seconds>B<>
...
=item B<hls_time> I<seconds>B<>

Set the target segment length in seconds. Default value is 2.
Segment will be cut on the next key frame after this time has passed.


=item B<hls_list_size> I<size>B<>

Set the maximum number of playlist entries. If set to 0 the list file
will contain all the segments. Default value is 5.


=item B<hls_delete_threshold> I<size>B<>
...
=item B<hls_ts_options> I<options_list>B<>
...
=item B<start_number> I<number>B<>
...
=item B<hls_allow_cache> I<allowcache>B<>

Explicitly set whether the client MAY (1) or MUST NOT (0) cache media segments.


=item B<hls_base_url> I<baseurl>B<>
...
=item B<hls_segment_filename> I<filename>B<>
...
=item B<hls_key_info_file> I<key_info_file>B<>
...
=item B<hls_fmp4_init_filename> I<filename>B<>
...
=item B<-frag_duration> I<duration>B<>

Create fragments that are I<duration> microseconds long.

=item B<-frag_size> I<size>B<>
...
=item B<-min_frag_duration> I<duration>B<>
...
=item B<mpegts_transport_stream_id> I<integer>B<>

Set the B<transport_stream_id>. This identifies a transponder in DVB.
Default is C<0x0001>.


=item B<mpegts_original_network_id> I<integer>B<>
...
=item B<mpegts_service_id> I<integer>B<>

Set the B<service_id>, also known as program in DVB. Default is
C<0x0001>.


=item B<mpegts_service_type> I<integer>B<>
...
=item B<store_user_comments> I<bool>B<>
...
=item B<-page_duration> I<duration>B<>
...
=item B<-serial_offset> I<value>B<>
...
=item B<reference_stream> I<specifier>B<>
...
=item B<segment_format> I<format>B<>

Override the inner container format, by default it is guessed by the filename
extension.


=item B<segment_format_options> I<options_list>B<>
...
=item B<segment_list> I<name>B<>

Generate also a listfile named I<name>. If not specified no
listfile is generated.


=item B<segment_list_flags> I<flags>B<>
...
=item B<segment_list_size> I<size>B<>
...
=item B<segment_list_entry_prefix> I<prefix>B<>

Prepend I<prefix> to each entry. Useful to generate absolute paths.
By default no prefix is applied.


=item B<segment_list_type> I<type>B<>
...
=item B<segment_atclocktime> I<1|0>B<>
...
=item B<segment_clocktime_offset> I<duration>B<>
...
=item B<segment_clocktime_wrap_duration> I<duration>B<>
...
=item B<segment_time_delta> I<delta>B<>
...
=item B<segment_times> I<times>B<>
...
=item B<segment_frames> I<frames>B<>
...
=item B<break_non_keyframes> I<1|0>B<>
...
=item B<reset_timestamps> I<1|0>B<>
...
=item B<initial_offset> I<offset>B<>

Specify timestamp offset to apply to the output packet timestamps. The
argument must be a time duration specification, and defaults to 0.


=item B<write_empty_segments> I<1|0>B<>
...
=item B<drop_pkts_on_overflow> I<bool>B<>
...
=item B<attempt_recovery> I<bool>B<>
...
=item B<recover_any_error> I<bool>B<>
...
=item B<restart_with_keyframe> I<bool>B<>
