...
=item B<-per_frame_metadata> I<boolean>B<>
...
=item B<-center_mixlev> I<level>B<>
...
=item B<-surround_mixlev> I<level>B<>
...
=item B<-mixing_level> I<number>B<>
...
=item B<-ltrt_surmixlev> I<level>B<>
...
=item B<-loro_surmixlev> I<level>B<>
...
=item B<-dheadphone_mode> I<mode>B<>
...
=item B<-stereo_rematrixing> I<boolean>B<>
...
=item B<-channel_coupling> I<boolean>B<>
...
=item B<-cpl_start_band> I<number>B<>
...
=item B<minrate, maxrate, b> I<end-usage=cbr>B<>
...
=item B<colorspace> I<color-space>B<>
...
=item B<-lossless> I<boolean>B<>

Enables/Disables use of lossless mode. Default is 0.


=item B<-compression_level> I<integer>B<>
...
=item B<seq_disp_ext> I<integer>B<>
...
=item B<video_format> I<integer>B<>
...
=item B<dpi> I<integer>B<>

Set physical density of pixels, in dots per inch, unset by default

=item B<dpm> I<integer>B<>
...
=item B<bits_per_mb> I<integer>B<>

How many bits to allot for coding one macroblock. Different profiles use
between 200 and 2400 bits per macroblock, the maximum is 8000.


=item B<mbs_per_slice> I<integer>B<>

Number of macroblocks in each slice (1-8); the default value (8)
should be good in almost all situations.


=item B<vendor> I<string>B<>
