...
=item B<-vstats_file> I<file>B<>

Dump video coding statistics to I<file>.

=item B<-vstats_version> I<file>B<>
...
=item B<-vbsf> I<bitstream_filter>B<>
...
=item B<-init_hw_device> I<type>B<[=>I<name>B<]@>I<source>B<>
...
=item B<-absf> I<bitstream_filter>B<>
...
=item B<-sbsf> I<bitstream_filter>B<>
...
=item B<-loop_output> I<number_of_times>B<>

Repeatedly loop output for formats that support looping such as animated GIF
(0 will loop the output infinitely).
This option is deprecated, use -loop.

=item B<-vsync> I<parameter>B<>
...
=item B<-frame_drop_threshold> I<parameter>B<>
...
=item B<-async> I<samples_per_second>B<>
...
=item B<-timecode> I<hh>B<:>I<mm>B<:>I<ss>B<SEP>I<ff>B<>
