...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -U__STRICT_ANSI__ -D_XOPEN_SOURCE=600 -DPIC -DZLIB_CONST
...
LDEXEFLAGS=
LDSOFLAGS=
SHFLAGS=-shared -Wl,--out-implib,$(SUBDIR)lib$(FULLNAME).dll.a -Wl,-Bsymbolic -Wl,--version-script,$(SUBDIR)lib$(NAME).ver
ASMSTRIPFLAGS= -x
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lgdi32 -lm -lvfw32 -lxcb -lxcb-shm -lxcb -lxcb-shape -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb
EXTRALIBS-avfilter=-pthread -lm
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -lz -lsecur32
EXTRALIBS-avcodec=-pthread -liconv -lm -llzma -lz -lole32 -luser32
EXTRALIBS-swresample=-lm
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-pthread -lm -luser32 -lbcrypt
